...
> **TL;DR** — Multi-language plan (EN / TR / ES first, PT-BR / AR / FA / more deferred). Hand-rolled approach (no `i18next`). ~200 UI strings to translate. Pattern names stay untranslated (proper nouns).
> **Audience:** anyone implementing the i18n pass.
> **Length:** ~200 lines · ~3 min read.
> **Best for:** the why-not-i18next decision, the string-inventory approach, RTL handling notes.
> **Status:** NOT STARTED. Implement after v1 user-testing settles.
